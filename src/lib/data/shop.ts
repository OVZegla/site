...
export const shopProducts: ShopProduct[] = [
  // ---------------------------------------------------------------- Encres
  {
    ...
    description: [
      "Formulation UV LED à séchage instantané, mise au point avec notre fabricant pour les têtes Epson montées sur nos machines.",
    ...
    compatibility: ["Opaline", "Graphite Edition", "M1", "Black 2.0", "Ruby", "White", "T1000"],
    variants: [
  ...
  {
    mode: "buy",
    slug: "tete-impression-epson-i1600",
    name: "Tête d'impression Epson I1600",
    ...
    specs: [
      { label: "Référence", value: "Epson I1600" },
      { label: "Configuration", value: "Tête couleur CMJN ou tête blanche" },
  ...
  },
  {
    ...
    compatibility: ["Opaline", "Graphite Edition", "M1", "Black 2.0", "Ruby", "White"],
    variants: [
      ...
      { id: "m1", label: "M1", priceDelta: 0, sku: "PRT-BELT-V-M1" },
      { id: "black", label: "Black 2.0", priceDelta: 500, sku: "PRT-BELT-V-BLK" },
    ],
    stock: 42,
    leadTime: "Expédition sous 24 h",
    featured: true,
  ...
  },
  {
    ...
    compatibility: ["Opaline", "M1", "Ruby", "Black 2.0"],
    stock: 23,
    leadTime: "Expédition sous 24 h",
  },
  {
  ...
  },
  {
    ...
    description: [
      ...
      "Compatible avec les bases de machines de la gamme professionnelle.",
    ],
    specs: [
